...
# Kevins Konten — beim ersten Start vorangelegt, Passwörter kommen über die UI
DEFAULT_ACCOUNTS = [
    "kevher@gmx.de", "adebroehoe@gmx.de", "kevherrmann@gmx.de",
    "zombi666999@hotmail.com", "kevinherrmann85@googlemail.com",
]

...
var EN = {
  ...
  "Papier": "Paper", "Nebel": "Mist",
  "Hell: Waldgrün auf warmem Papierweiß.": "Light: forest green on warm paper white.",
  "Hell: Tintenblau auf kühlem Grau.": "Light: ink blue on cool gray.",
  "🗂 WORAN GEARBEITET": "🗂 WORKED ON", "Session öffnen": "Open session",
  "Ziehen = Breite ändern · Doppelklick = Standard": "Drag = resize · double-click = default",
...
var RX = [
  ...
  [/^Reset: (.+) Uhr$/, 'Reset: $1'],
  [/^(\d+) Eingaben?$/, function(m,n){return n+(n==='1'?' prompt':' prompts');}],
